...
/**
 * inorder_sucessor - this determines the next/previous
 ...
 * @arg_tree: the pointer to the removed node
 * @arg_node: the pointer to the next/previous node
 * Return: no return
 */
 ...
 * Return: the pointer the removed node
 */
