...
/**
 * r_case - this removes a node from a Binary Search Tree
 * for node->right case
 * @root: this is the tree root
 * @node: the node to delete
 * Return: the pointer the tree root
 */
...
/**
 * r_l_case - this removes a node from a Binary Search Tree
 * for node->right->l case
 * @root: this is the tree root
 * @node: the node to delete
 * Return: the pointer the tree root
 */
