...
/**
 * check_parent - this checks if node has a lower/higher
 * than its grand parent
 * @tree: this is the actual node
...
/**
 * check_is_bst - this checks if the binary tree is a BST
...
/**
 * binary_tree_is_bst - this calls to check_is_bst
 * to check if tree is BST
 * @tree: this is the ree root
 * Return: 1 if tree is a BST, 0 otherwise
 */
